...
import baseBarForm from '@juggle-data-view/echarts-common/src/configs/templates/baseBarForm';
import baseBarConfig from '@juggle-data-view/echarts-common/src/temps/base_bar';
